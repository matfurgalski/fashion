        ...
        <div class="container">
            <div class="row">
                ...
                <div class="col-lg-6 col-md-6">
                    <nav class="header__menu mobile-menu">
                        <ul>
                            <li class="active"><a href="{$conf->action_root}home">Strona Główna</a></li>
                            <li><a href="{$conf->action_root}sklep">Sklep</a></li>

                            {if count($conf->roles)>0}
                            {if isset($conf->roles['admin']) == 1}
                            <li><a href="{$conf->action_root}listaUzytkownikow">Lista Kont</a></li>
                            {/if}
                            {/if}
                            ...
                            <li><a href="{$conf->action_root}listaZamowien">Lista Zamowień</a></li>
                            {/if}
                            {/if}
                        </ul>
                    </nav>
