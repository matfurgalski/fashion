...
Utils::addRoute('newletter', 'HomeCtrl');
...
Utils::addRoute('listaZamowien', 'ListaZamowienCtrl',['pracownik']);
Utils::addRoute('szczegolyZamowienia', 'SzczegolyZamowieniaCtrl',['pracownik']);
Utils::addRoute('zmienStatus', 'SzczegolyZamowieniaCtrl',['pracownik']);
Utils::addRoute('listaUzytkownikow', 'ListaUzytkownikowCtrl',['admin']);
Utils::addRoute('listaUzytkownikowCzesc', 'ListaUzytkownikowCtrl',['admin']);
